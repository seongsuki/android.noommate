...
public class BackAdapter extends BaseQuickAdapter<BaseModel, BaseViewHolder> {
    public BackAdapter(int layoutResId, @Nullable List<BaseModel> data) {
    ...
    protected void convert(BaseViewHolder helper, BaseModel item) {
        ...
        if (helper.getLayoutPosition() == 0) {
            helper.setImageDrawable(R.id.image_view, mContext.getDrawable(R.drawable.back5));
        } else if (helper.getLayoutPosition() == 1) {
            helper.setImageDrawable(R.id.image_view, mContext.getDrawable(R.drawable.back4));
        } else if (helper.getLayoutPosition() == 2) {
            helper.setImageDrawable(R.id.image_view, mContext.getDrawable(R.drawable.back3));
